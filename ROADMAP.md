...
- [ ] 3rd boolean type on mode, "intersect", which will only keep intersecting geometry, treated as add. outlying pieces are ignored (and not treated as subtract)
- [ ] Per point size and rotation flags, with an optional bezier transition variable.
