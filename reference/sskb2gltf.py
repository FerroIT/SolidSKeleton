#!/usr/bin/env python3
"""Convert .sskb binary files to glTF 2.0 (.glb or .gltf).

Usage:
    python sskb2gltf.py <input.sskb> [-o <output.glb>] [--format glb|gltf]
...
from ssklib.parse_sskb import parse
...
def main():
    ap = argparse.ArgumentParser(prog='sskb2gltf',
                                 description='Convert .sskb to glTF 2.0')
    ap.add_argument('input', help='input .sskb file')
